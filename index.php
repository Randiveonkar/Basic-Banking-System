...
<head>
    ...
    <link rel="shortcut icon" href="cm.png">
...
<body >
	...
	<div id="header">
       ...
       <h2 style=" font-family:Agency FB; font-size: 55px;color:#ee10ee;text-shadow: 2px 2px black;"> By:- Onkar Randive </h2>
       <h2 style=" font-family:Agency FB; font-size: 55px;color:#00ff00;text-shadow: 2px 2px black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Basic Banking System </h2>
    </div>
        <div id="section">
            <table>
                <tr></tr>
